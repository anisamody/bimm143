...
This lab focuses on using pathway and gene set analysis to interpret
large RNA-seq gene lists by identifying enriched biological pathways,
processes, and functions. By connecting differentially expressed genes
to known annotations, the analysis provides deeper biological insight
into the molecular mechanisms underlying the studied condition.
...
> Question 1. Complete the code below to remove the troublesome first
...
> Question 2. Complete the code below to filter countData to exclude
...
> Question 3. Call the summary() function on your results to get a sense
...
![](class_14_lab_files/figure-commonmark/unnamed-chunk-12-1.png)
...
![](class_14_lab_files/figure-commonmark/unnamed-chunk-13-1.png)

> Question 4. Improve this plot by completing the below code, which adds
> color, axis labels and cutoff lines:
...
![](class_14_lab_files/figure-commonmark/unnamed-chunk-14-1.png)

## Add Annotation Data

> Question 5. Use the mapIDs() function multiple times to add SYMBOL,
...
> Question 6. Finally for this section let’s reorder these results by
...
Note: We used the mapIDs() function above to obtain Entrez gene IDs
...
```
    ...
    Info: Working in directory /Users/anisa/BIMM 143/bimm143/class14

    Info: Writing image file hsa04110.pathview.png

![](hsa04110.pathview.png)

We can play with the other input arguments to pathview() to change the
...
> Question 7. Can you do the same procedure as above to plot the
> pathview figures for the top 5 down-regulated pathways?
...
> Question 8. What pathway has the most significant “Entities p-value”?
> Do the most significant pathways listed match your previous KEGG
> results? What factors could cause differences between the two methods?

The pathway with the most significant Entities p-value is Cell Cycle (p
= 2.63E-5), followed very closely by Cell Cycle, Mitotic (p = 2.78E-5).
These results indicate that cell cycle–related pathways are the
strongest overrepresented biological processes in your significant gene
set. Yes, these top Reactome pathways generally match the previous KEGG
results if KEGG also highlighted cell cycle, DNA replication, or
mitosis-related pathways, suggesting strong biological consistency
across analyses. However, differences between Reactome and KEGG can
arise because each database has distinct pathway definitions, gene
annotations, curation methods, pathway granularity, and statistical
frameworks, which can lead to variation in pathway rankings and
significance values.
